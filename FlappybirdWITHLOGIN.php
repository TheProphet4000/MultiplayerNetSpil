...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location: http://localhost/MultiplayerNetSpil/LogInSite/login.php");
    exit;
}
...
<input style="position:fixed; bottom:400px; left:5%; height:350px; width:200px;" type="button" onclick="restart()" value="Reset">
<input style="position:fixed; bottom:50px; left:5%; height:350px; width:200px;" type="button" onclick="back()" value="Back" name="back">
<script>
